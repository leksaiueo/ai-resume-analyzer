    ...
    <div className="bg-white rounded-2xl shadow-md w-full">
      <div className="flex flex-row items-center p-4 gap-8">
        ...
        <div className="flex flex-col gap-2">
          <h2 className="text-2xl font-bold">Skor Resume mu</h2>
          <p className="text-sm text-gray-500">
            Skor ini dihitung dari beberapa faktor yang tercantum di bawah ini,
            jadi kamu bisa lihat jelas apa saja yang memengaruhi hasilnya.
          </p>
        </div>
      </div>
