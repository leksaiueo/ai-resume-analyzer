...
export const AIResponseFormat = `
      ...
      toneAndStyle: {
        ...
        tips: {
          type: "good" | "improve";
          tip: string; //jadikan ini judul singkat untuk penjelasan sebenarnya
...
export const prepareInstructions = ({
  ...
  `Anda adalah ahli dalam ATS (Applicant Tracking System) dan analisis resume.
      Silakan analisis dan beri nilai resume ini serta sarankan cara memperbaikinya.
      ...
      Jika tersedia, gunakan deskripsi pekerjaan untuk pekerjaan yang dilamar pengguna untuk memberikan feedback yang lebih detail.
      ...
      Berikan feedback menggunakan format berikut: ${AIResponseFormat}
      Kembalikan analisis sebagai objek JSON, tanpa teks lain dan tanpa backticks.
      Jangan sertakan teks lain atau komentar.`;
